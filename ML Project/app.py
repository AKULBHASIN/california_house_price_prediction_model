...
st.sidebar.image('https://img.staticmb.com/mbcontent/images/crop/uploads/2025/6/Selling-Property_0_1200.jpg.webp')
...
with open('house_price_pred_ridgemodel.pkl', 'rb')as f:
...
place = st.empty()
place.image('https://cdn-icons-gif.flaticon.com/6844/6844458.gif', width = 50)
